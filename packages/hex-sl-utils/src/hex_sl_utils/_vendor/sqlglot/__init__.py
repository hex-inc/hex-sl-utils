...
from hex_sl_utils._vendor.sqlglot import expressions as exp
from hex_sl_utils._vendor.sqlglot.dialects.dialect import Dialect as Dialect, Dialects as Dialects
from hex_sl_utils._vendor.sqlglot.diff import diff as diff
from hex_sl_utils._vendor.sqlglot.errors import (
    ErrorLevel as ErrorLevel,
    ParseError as ParseError,
    TokenError as TokenError,
    UnsupportedError as UnsupportedError,
)
from hex_sl_utils._vendor.sqlglot.expressions import (
...
from hex_sl_utils._vendor.sqlglot.generator import Generator as Generator
from hex_sl_utils._vendor.sqlglot.parser import Parser as Parser
from hex_sl_utils._vendor.sqlglot.schema import MappingSchema as MappingSchema, Schema as Schema
from hex_sl_utils._vendor.sqlglot.tokens import Token as Token, Tokenizer as Tokenizer, TokenType as TokenType

if t.TYPE_CHECKING:
    from hex_sl_utils._vendor.sqlglot._typing import E
    from hex_sl_utils._vendor.sqlglot.dialects.dialect import DialectType as DialectType

logger = logging.getLogger("sqlglot")


try:
    from hex_sl_utils._vendor.sqlglot._version import __version__, __version_tuple__
except ImportError:
    logger.error(
