...
from hex_sl_utils._vendor.sqlglot.dialects import DIALECT_MODULE_NAMES
from hex_sl_utils._vendor.sqlglot.errors import ParseError
from hex_sl_utils._vendor.sqlglot.generator import Generator, unsupported_args
from hex_sl_utils._vendor.sqlglot.helper import (
    AutoName,
    flatten,
    is_int,
    seq_get,
...
from hex_sl_utils._vendor.sqlglot.jsonpath import JSONPathTokenizer, parse as parse_json_path
from hex_sl_utils._vendor.sqlglot.parser import Parser
from hex_sl_utils._vendor.sqlglot.time import TIMEZONES, format_time, subsecond_precision
from hex_sl_utils._vendor.sqlglot.tokens import Token, Tokenizer, TokenType
from hex_sl_utils._vendor.sqlglot.trie import new_trie
...
if t.TYPE_CHECKING:
    from hex_sl_utils._vendor.sqlglot._typing import B, E, F

    from hex_sl_utils._vendor.sqlglot.optimizer.annotate_types import TypeAnnotator
...
class _Dialect(type):
    ...
    def _try_load(cls, key: str | Dialects) -> None:
        ...
        if key in DIALECT_MODULE_NAMES:
            importlib.import_module(f"hex_sl_utils._vendor.sqlglot.dialects.{key}")
