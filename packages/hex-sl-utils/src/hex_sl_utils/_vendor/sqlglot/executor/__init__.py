...
from hex_sl_utils._vendor.sqlglot.errors import ExecuteError
from hex_sl_utils._vendor.sqlglot.executor.python import PythonExecutor
from hex_sl_utils._vendor.sqlglot.executor.table import Table, ensure_tables
from hex_sl_utils._vendor.sqlglot.helper import dict_depth
from hex_sl_utils._vendor.sqlglot.optimizer import optimize
from hex_sl_utils._vendor.sqlglot.optimizer.annotate_types import annotate_types
from hex_sl_utils._vendor.sqlglot.planner import Plan
from hex_sl_utils._vendor.sqlglot.schema import ensure_schema, flatten_schema, nested_get, nested_set

logger = logging.getLogger("sqlglot")

if t.TYPE_CHECKING:
    from hex_sl_utils._vendor.sqlglot.dialects.dialect import DialectType
    from hex_sl_utils._vendor.sqlglot.expressions import Expression
    from hex_sl_utils._vendor.sqlglot.schema import Schema
