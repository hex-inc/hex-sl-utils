...
from hex_sl_utils._vendor.sqlglot.errors import ErrorLevel, ParseError
...
from hex_sl_utils._vendor.sqlglot.tokens import Token, TokenError
...
class Expression(metaclass=_Expression):
    ...
    def dump(self):
        ...
        """
        from hex_sl_utils._vendor.sqlglot.serde import dump
    ...
    def load(cls, obj):
        ...
        """
        from hex_sl_utils._vendor.sqlglot.serde import load
...
def normalize_table_name(table: str | Table, dialect: DialectType = None, copy: bool = True) -> str:
    ...
    Examples:
        ...
        'A-B.c'
    """
    from hex_sl_utils._vendor.sqlglot.optimizer.normalize_identifiers import normalize_identifiers
