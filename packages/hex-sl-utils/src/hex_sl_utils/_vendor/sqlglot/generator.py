...
from hex_sl_utils._vendor.sqlglot.errors import ErrorLevel, UnsupportedError, concat_messages
from hex_sl_utils._vendor.sqlglot.helper import apply_index_offset, csv, name_sequence, seq_get
from hex_sl_utils._vendor.sqlglot.jsonpath import ALL_JSON_PATH_PARTS, JSON_PATH_PART_TRANSFORMS
from hex_sl_utils._vendor.sqlglot.time import format_time
from hex_sl_utils._vendor.sqlglot.tokens import TokenType

if t.TYPE_CHECKING:
    from hex_sl_utils._vendor.sqlglot._typing import E
...
class Generator(metaclass=_Generator):
    ...
    def __init__(
        ...
        import hex_sl_utils._vendor.sqlglot as sqlglot
        from hex_sl_utils._vendor.sqlglot.dialects import Dialect
    ...
    def preprocess(self, expression: exp.Expression) -> exp.Expression:
        ...
        if self.ENSURE_BOOLS:
            from hex_sl_utils._vendor.sqlglot.transforms import ensure_bools
    ...
    def _move_ctes_to_top_level(self, expression: E) -> E:
        if (
            ...
            from hex_sl_utils._vendor.sqlglot.transforms import move_ctes_to_top_level
    ...
    def dateadd_sql(self, expression: exp.DateAdd) -> str:
        from hex_sl_utils._vendor.sqlglot.dialects.dialect import unit_to_str
