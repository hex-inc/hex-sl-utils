...
from hex_sl_utils._vendor.sqlglot.optimizer.normalize import normalized
from hex_sl_utils._vendor.sqlglot.optimizer.scope import build_scope, find_in_scope
from hex_sl_utils._vendor.sqlglot.optimizer.simplify import simplify
from hex_sl_utils._vendor.sqlglot import Dialect
...
def pushdown_predicates(expression, dialect=None):
    ...
    """
    from hex_sl_utils._vendor.sqlglot.dialects.athena import Athena
    from hex_sl_utils._vendor.sqlglot.dialects.presto import Presto
