...
from hex_sl_utils._vendor.sqlglot.optimizer.qualify_columns import Resolver
from hex_sl_utils._vendor.sqlglot.optimizer.scope import Scope, traverse_scope
...
from hex_sl_utils._vendor.sqlglot.helper import seq_get
