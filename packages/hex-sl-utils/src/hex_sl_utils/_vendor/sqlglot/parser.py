...
from hex_sl_utils._vendor.sqlglot.errors import ErrorLevel, ParseError, concat_messages, merge_errors
from hex_sl_utils._vendor.sqlglot.helper import apply_index_offset, ensure_list, seq_get
...
from hex_sl_utils._vendor.sqlglot.trie import TrieResult, in_trie, new_trie

if t.TYPE_CHECKING:
    from hex_sl_utils._vendor.sqlglot._typing import E, Lit
    from hex_sl_utils._vendor.sqlglot.dialects.dialect import Dialect, DialectType
...
class Parser(metaclass=_Parser):
    ...
    def _implicit_unnests_to_explicit(self, this: E) -> E:
        from hex_sl_utils._vendor.sqlglot.optimizer.normalize_identifiers import normalize_identifiers as _norm
